  ...
  return (
    <footer className="bg-[var(--background)] py-10 text-[var(--foreground)]">
      <div className="max-w-[1440px] mx-auto px-6 md:px-20">
        <div className="w-full border-t border-[var(--border)] pt-10" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-center justify-between mb-16">
          <div className="flex justify-start">
            <img
              ...
              alt="Jay Jay He Logo"
              className="h-5 opacity-60 invert brightness-0 invert-100 [html[data-theme='light']_&]:invert-0 [html[data-theme='light']_&]:brightness-0"
            />
          </div>
          ...
          <div className="flex justify-end items-center gap-8 text-[11px] uppercase tracking-widest text-[var(--muted-foreground)]">
        ...
        <div className="flex justify-between items-center text-[10px] text-[var(--muted-foreground)] uppercase tracking-widest">
